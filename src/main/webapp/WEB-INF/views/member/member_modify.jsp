...
$(function() {
    ...
    let focusdata = '';
     ...
     $('#form').submit(function (e) {
         ...
         $.ajax({
 			...
 			success: function(data) {
 				...
 				console.log(data);
 				if(data === "true"){
 					 a_userData.name = $('#name').val();
 		             a_userData.email = $('#email').val();
 		             a_userData.phone_number = $('#phone_number').val();
 					 dupData();
 				}else if (data === "false"){
 					$('#resultMessage').empty();
 					$('#resultModal').modal('show');
 					$('#resultMessage').text("비밀번호를 잘못 입력하셨습니다.");	
 				}
     ...
     function equalsCheck(){
    	 let userData ={
    			 "user_id" : id,
    	    	 "name" : (b_userData.name !== a_userData.name) ? a_userData.name : "null" ,
    	    	 "email" : (b_userData.email !== a_userData.email) ? a_userData.email : "null" ,
    	    	 "phone_number" : (b_userData.phone_number !== a_userData.phone_number) ? a_userData.phone_number : "null" 
    	 }; 
	...
	<div id="main" class="container my-5">
		<div class="row justify-content-center">
			<div class="col-md-6">
				...
				<form action="" class="pt-5" id="form" method="post"> <!-- Added method="post" attribute -->
